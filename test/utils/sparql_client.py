# Simplified from https://github.com/csse-uoft/owlready2/blob/master/src/owlready2/backend/sparql_client.py
import re
import requests
import urllib
...
class SparqlClient:
    ...
    def execute_sparql(self, *query, infer=True, method=None):
        """
